...
import '../Options.dart';
import '../Questions/advancedQues.dart';
import '../quizLevel.dart';

class advancedQuizPage extends StatefulWidget {
  const advancedQuizPage({Key? key}) : super(key: key);

  @override
  _advancedQuizPageState createState() => _advancedQuizPageState();
}
...
class _advancedQuizPageState extends State<advancedQuizPage> {
  ...
  void _questionAnswered(bool answerScore) {
    setState(() {
      ...
      //when the quiz ends
      if (_questionIndex + 1 == advancedQues.length) {
        endOfQuiz = true;
      }
    });
  }
  ...
  void _nextQuestion() {
    ...
    if (_questionIndex >= advancedQues.length) {
      _resetQuiz();
    }
  }
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text(
                'Your Score: ${_totalScore * 10}/${advancedQues.length * 10}',
                style: TextStyle(
                  fontSize: 20.0,
                  ...
                  child: Center(
                    child: Column(
                      children: [
                        ...
                        advancedQues[_questionIndex]['category'] == 'image'
                            ? Column(
                                children: [
                                  Text(
                                    advancedQues[_questionIndex]['question']
                                        as String,
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontSize: 20.0,
                            ...
                            : advancedQues[_questionIndex]['category'] ==
                                    'audio'
                                ? Column(
                                    children: [
                                      Text(
            ...
            ...(advancedQues[_questionIndex]['answers']
                ...
                if (endOfQuiz) {
                  showDialog(
                      ...
                      builder: (context) => AlertDialog(
                            ...
                            content: Text(
                                _totalScore > 6
                                    ? 'Congratulations! \n Your final score is: ${_totalScore * 10}/${advancedQues.length * 10}'
