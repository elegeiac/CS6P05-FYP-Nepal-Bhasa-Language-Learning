...
class intermmediateQuizPage extends StatefulWidget {
  const intermmediateQuizPage({Key? key}) : super(key: key);

  @override
  _intermmediateQuizPageState createState() => _intermmediateQuizPageState();
}

class _intermmediateQuizPageState extends State<intermmediateQuizPage> {
  ...
  void _questionAnswered(bool answerScore) {
    setState(() {
      ...
      //when the quiz ends
      if (_questionIndex + 1 == intermmediateQues.length) {
        endOfQuiz = true;
      }
    });
  }
  ...
  void _nextQuestion() {
    ...
    if (_questionIndex >= intermmediateQues.length) {
      _resetQuiz();
    }
  }
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text(
                'Your Score: ${_totalScore * 10}/${intermmediateQues.length * 10}',
                style: TextStyle(
                  fontSize: 20.0,
                  ...
                  child: Center(
                    child: Column(
                      children: [
                        ...
                        intermmediateQues[_questionIndex]['category'] == 'image'
                            ? Column(
                                children: [
                                  Text(
                                    intermmediateQues[_questionIndex]
                                        ['question'] as String,
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontSize: 20.0,
                            ...
                            : intermmediateQues[_questionIndex]['category'] ==
                                    'audio'
                                ? Column(
                                    children: [
                                      Text(
            ...
            ...(intermmediateQues[_questionIndex]['answers']
                ...
                if (endOfQuiz) {
                  showDialog(
                      ...
                      builder: (context) => AlertDialog(
                            ...
                            content: Text(
                                _totalScore > 6
                                    ? 'Congratulations! \n Your final score is: ${_totalScore * 10}/${intermmediateQues.length * 10}'
